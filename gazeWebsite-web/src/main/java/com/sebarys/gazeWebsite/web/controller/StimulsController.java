...
public class StimulsController extends AbstractController<Stimul, DtoStimul, StimulService> {
    ...
    public DtoStimul getStimulDetails(@PathVariable final Long stimulId) throws IOException {
        if(stimulId == null){
            return null;
        }
        DtoStimul stimulDetails = service.getStimulDetails(stimulId);
        return stimulDetails;
    }
